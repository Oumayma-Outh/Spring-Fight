...
import com.bgrant.sfs.objects.FighterChoice;
...
public class MainMenuScreen implements Screen {
    ...
    private void createImages() {
        ...
        logoImage.setSize(logoImage.getWidth() * GlobalVariables.WORLD_SCALE, logoImage.getHeight() *
    ...
    private void addButtonListeners() {
        ...
        playGameButton.addListener(new ChangeListener() {
            ...
            public void changed(ChangeEvent event, Actor actor) {
                ...
                // choose a random opponent fighter from the fighter choice list, making sure it's different from player's
                // fighter
        ...
        previousFighterButton.addListener(new ChangeListener() {
            ...
            public void changed(ChangeEvent event, Actor actor) {
                ...
                // choose the previous fighter in the fighter choice list, or choose the last fighter if the beginning of
        ...
        nextFighterButton.addListener(new ChangeListener() {
            ...
            public void changed(ChangeEvent event, Actor actor) {
                ...
                // choose the next fighter in the fighter choice list, or choose the first fighter if the end of
                // the list has been reached
    ...
    private void createLabels() {
        // get the small font from the asset manager
    ...
    private void createTables() {
        ...
        // add the logo image to the left side table and start a new row
        ...
        // create the fighter display inner table and add the previous and next fighter buttons and the fighter display
        // image to it
        ...
        // fill in the fighter display table with an empty on top (for alignment), the fighter display inner table in the
        // center, and the fighter display name label at the bottom
        fighterDisplayTable.add().height(fighterDisplayBackgroundImage.getHeight() / 2f - fighterDisplayImage.getHeight() /
                2f - 0.5f);
